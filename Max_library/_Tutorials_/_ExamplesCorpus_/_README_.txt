...
2 Use the script FromTextToDYCI2json_script (/!\ No "." or " "in the whole path of the file (except extension) /!\), for example :

	$ python FromTextToDYCI2json_script.py [absolute path to the .csv/.txt file]

3 Move the .json file and your .aif sound file in /MaxPatches/_Tutorials_/_ExamplesCorpus_
