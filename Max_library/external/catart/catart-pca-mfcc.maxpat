...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.5, 354.917114, 106.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 233.0, 355.417114, 50.0, 21.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 737.0, 208.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 713.0, 208.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 689.0, 208.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 86.5, 258.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "int", "" ],
					"patching_rect" : [ 114.0, 251.5, 251.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 223.0, 427.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 432.230103, 289.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 716.5, 12.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 601.5, 146.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "name corpus"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 440.0, 196.0, 138.539795, 22.0 ],
					"style" : "",
					"text" : "b 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 129.0, 310.0, 22.0 ],
					"style" : "",
					"text" : "readappend \"'vent desert large sifflant.aif\" @name audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 303.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 232.0, 206.479492, 108.0, 33.0 ],
									"style" : "",
									"text" : "prepend view pcaout"
								}
...
,
					"patching_rect" : [ 594.0, 122.5, 45.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 114.0, 411.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 716.5, 46.0, 92.0, 21.0 ],
					"style" : "",
					"text" : "unpack 0 1 -1 -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 670.5, 12.5, 33.0, 21.0 ],
					"style" : "",
					"text" : "r init"
				}
...
, 			{
				"box" : 				{
					...
					"cursor_position" : -3.845334,
					"cursor_shape" : "cross",
					"cursor_size" : 3,
					"cursor_visible" : 1,
					"domain_bounds" : [ -3.943219, -2.093439 ],
					...
					"outputvalues" : 1,
					"patching_rect" : [ 594.0, 171.0, 774.0, 711.0 ],
					"presentation_rect" : [ 0.0, 0.0, 3823.0, 1003.0 ],
					"rangeruler_grid" : 0,
					"rangeruler_size" : 35,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.0, 411.0, 65.0, 20.0 ],
					"style" : "",
					"text" : "select 0..1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 436.0, 83.0, 21.0 ],
					"style" : "",
					"text" : "scaling minmax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 209.0, 303.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 133"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 323.0, 127.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 114.0, 323.0, 87.0, 22.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 312.0, 323.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 428.0, 117.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -12.5, 212.0, 99.0, 31.0 ],
					"style" : "",
					"text" : "analysis"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 86.5, 212.0, 27.5, 27.5 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 310.0, 53.0, 50.0, 21.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 310.0, 82.0, 72.0, 21.0 ],
									"style" : "",
									"text" : "chop.size $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 297.0, 121.0, 218.0, 21.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 870.0, 217.0, 68.0, 22.0 ],
									"style" : "",
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 870.0, 242.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "int", "" ],
									"patching_rect" : [ 10.0, 177.0, 409.0, 77.0 ],
									"style" : "",
									"text" : "mubu.process corpus audio mfcc:chop:scale @name descr @process 0 @progressoutput input @timetagged 1 @chop.size 750 @chop.mean 1 @scale.inmin -100 0 @scale.inmax 100 10 @scale.complete 0",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
,
					"patching_rect" : [ 114.0, 217.5, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Geneva",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 99.5, 251.917114, 106.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "mubuname corpus, getmatrixcols, getmatrixcolnames"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 337.0, 206.0, 84.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 266.0, 139.0, 136.0, 22.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 432.230103, 323.0, 72.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Geneva",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 400.0, 171.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 249.0, 428.0, 123.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 316.0, 85.0, 31.0 ],
					"style" : "",
					"text" : "trigger"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 389.0, 452.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.0, 639.0, 468.75, 40.0 ],
					"style" : "",
					"text" : "mubu.concat~ 2 corpus @audio audio @markers descr @positionvar 50 @play 0 @autotrigger 1 @attack 250 @release 450"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.0, 504.0, 267.0, 24.0 ],
					"style" : "",
					"text" : "mubu.knn corpus pcaout @radius 0 @k 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 306.5, 507.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 326.5, 507.0, 32.0, 21.0 ],
									"style" : "",
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 356.5, 507.0, 65.0, 21.0 ],
									"style" : "",
									"text" : "print toknn"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 628.0, 129.0, 45.0, 19.0 ],
									"style" : "",
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 850.5, 162.275269, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 850.5, 191.0, 105.0, 21.0 ],
									"style" : "",
...
,
									"patching_rect" : [ 698.0, 191.0, 82.0, 21.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontname" : "Geneva",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 608.0, 240.0, 429.0, 33.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 608.0, 322.0, 104.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 658.0, 216.0, 205.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 578.0, 290.0, 84.0, 21.0 ],
									"style" : "",
									"text" : "foremost descr"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 578.0, 166.275269, 179.0, 18.0 ],
									"style" : "",
									"text" : "t b b b b 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 578.0, 350.0, 47.0, 21.0 ],
									"style" : "",
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 578.0, 136.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 628.0, 100.0, 43.0, 20.0 ],
									"style" : "",
									"text" : "set up"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 578.0, 100.0, 45.0, 19.0 ],
									"style" : "",
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 778.0, 380.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 798.0, 380.0, 32.0, 21.0 ],
									"style" : "",
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 828.0, 380.0, 65.0, 21.0 ],
									"style" : "",
									"text" : "print toed2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 578.0, 403.582886, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 155.5, 290.0, 111.0, 21.0 ],
									"style" : "",
									"text" : "prepend view pcaout"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 290.0, 91.0, 21.0 ],
									"style" : "",
									"text" : "foremost pcaout"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 707.5, 193.137634, 707.5, 193.137634 ],
									"source" : [ "obj-12", 3 ]
								}
...
,
					"patching_rect" : [ 454.960236, 80.0, 87.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 197.5, 247.5, 409.5, 247.5 ],
					"source" : [ "obj-69", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 348.375, 683.0, 168.5, 683.0 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 348.375, 683.0, 198.0, 683.0 ],
					"source" : [ "obj-30", 1 ]
				}
