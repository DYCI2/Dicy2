...
def create_factor_oracle_navigator(factor_oracle_navigator, sequence = [], labels = [], max_continuity = 2, control_parameters = [], equiv = (lambda x,y : x == y)):
	""" 
	...
	Navigator.__init__(factor_oracle_navigator, sequence, labels, max_continuity, control_parameters, equiv)
	FactorOracle.__init__(factor_oracle_navigator,sequence,labels,equiv)
...
def reinit_navigation_param(factor_oracle_navigator):
	...
	factor_oracle_navigator.current_navigation_index = 0
...
def free_navigation(factor_oracle_navigator, length, new_max_continuity = None, forward_context_length_min = 0, init = False, equiv = None, print_info = False):
	""" Free navigation through the automaton. 
		...
		:rtype: list (int)
		:seealso: :meth:`Navigator.free_generation` 
	...
	for i in range(0,length):
		str_print_info = "{} (cont. = {}/{}): {}".format(i, factor_oracle_navigator.current_continuity, factor_oracle_navigator.max_continuity, factor_oracle_navigator.current_navigation_index)

		s = None
		init_continuations, filtered_continuations = factor_oracle_navigator.filtered_continuations(factor_oracle_navigator.current_navigation_index, forward_context_length_min, equiv)
		...
		if not s is None:
			...
			if not s is None:
				...
				s = factor_oracle_navigator.navigate_without_continuation(init_continuations)	
				if not s is None:
		...
		if not s is None:
			factor_oracle_navigator.current_navigation_index = s 
...
def simply_guided_navigation(factor_oracle_navigator, required_labels, new_max_continuity = None, forward_context_length_min = 0, init = False, equiv = None, print_info = False, shift_index = 0, break_when_none = False):
	""" Navigation through the automaton, simply guided step by step by an input sequence of label.
		...
		:return: list of indexes of the generated path.
		:rtype: list (int)
		:seealso: :meth:`Navigator.simply_guided_generation`
		:seealso: Tutorial in FactorOracleNavigator_tutorial.py.
	...
	if init:
		...
		factor_oracle_navigator.current_navigation_index = init_states[random.randint(0, len(init_states)-1)]
...
def simply_guided_navigation_one_step(factor_oracle_navigator, required_label, new_max_continuity = None, forward_context_length_min = 0, equiv = None, print_info = False, shift_index = 0):
	...
	str_print_info = "{} (cont. = {}/{}): {}".format(shift_index, factor_oracle_navigator.current_continuity, factor_oracle_navigator.max_continuity, factor_oracle_navigator.current_navigation_index)

	s = None
	init_continuations_matching_label, filtered_continuations_matching_label = factor_oracle_navigator.filtered_continuations_with_label(factor_oracle_navigator.current_navigation_index, required_label, forward_context_length_min, equiv)
...
# 	def simply_guided_navigation(self, required_labels, new_max_continuity = None, forward_context_length_min = 0, init = False, equiv = None, print_info = False, shift_index = 0, break_when_none = False):
		...
		# :return: List of indexes of the generated path.
		# :rtype: list (int)
		# :seealso: FactorOracleNavigator.simply_guided_navigation(...) 
...
# 		return init_continuations, filtered_continuations				
	...
	# 	>>> 
	# 	>>> guide = ['C','A','B','B','C', 'C', 'D']
	# 	>>> generated_sequence = FON.simply_guided_navigation(guide, forward_context_length_min = forward_context_length_min, init = True, print_info = True)
