...
def new_generator_from_dict_memory(dict_memory, keys_labels , keys_contents, model_navigator = "FactorOracleNavigator", equiv = (lambda x,y : x == y), 
	...
	return Generator(sequence = contents, labels = labels, model_navigator = model_navigator, equiv = equiv,
		label_type = label_type, content_type = content_type, authorized_tranformations = authorized_tranformations, 
		continuity_with_future = continuity_with_future)


def new_generation_handler_from_dict_memory(dict_memory, keys_labels , keys_contents, model_navigator = "FactorOracleNavigator", equiv = (lambda x,y : x == y),
	label_type = None, content_type = None, authorized_tranformations = [0], continuity_with_future = [0.0, 1.0]):
	...
	return GenerationHandler(sequence = contents, labels = labels, model_navigator = model_navigator, equiv = equiv,
		label_type = label_type, content_type = content_type, authorized_tranformations = authorized_tranformations, continuity_with_future = continuity_with_future)


def new_generator_from_json_file(path_json_file, keys_labels , keys_contents, model_navigator = "FactorOracleNavigator", equiv = (lambda x,y : x == y),
	label_type = None, content_type = None, authorized_tranformations = [0], continuity_with_future = [0.0, 1.0]):
	"""
	...
	return new_generator_from_dict_memory(dict_memory = dict_memory, keys_labels = keys_labels, keys_contents = keys_contents, 
		model_navigator = model_navigator, equiv = equiv, label_type = label_type, content_type = content_type, authorized_tranformations = authorized_tranformations, continuity_with_future = continuity_with_future)


def new_generation_handler_from_json_file(path_json_file, keys_labels , keys_contents, model_navigator = "FactorOracleNavigator", equiv = (lambda x,y : x == y),
	label_type = None, content_type = None, authorized_tranformations = [0], continuity_with_future = [0.0, 1.0]):
	"""
	...
	return new_generation_handler_from_dict_memory(dict_memory = dict_memory, keys_labels = keys_labels, keys_contents = keys_contents, 
		model_navigator = model_navigator, equiv = equiv, label_type = label_type, content_type = content_type, authorized_tranformations = authorized_tranformations,
		continuity_with_future = continuity_with_future)
