...
* Insert the media files downloaded at http://repmus.ircam.fr/nika/dyci2_library in "MaxPatches/Tutorials/\_ExamplesCorpus\_". /!\ The sampling rate of Max MUST be the same as that of the audio file(s) used in the memory(/ies). /!\ 
