...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "int", "" ],
									"patching_rect" : [ 26.5, 154.5, 469.0, 77.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 486.0, 235.25, 430.0, 235.25 ],
									"order" : 1,
									"source" : [ "obj-1", 3 ]
								}
